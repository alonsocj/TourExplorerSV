        ...
        <article class="card-body">
          ...
          <form id="form-register">
            ...
            <div class="form-group mb-3">
              ...
              <input type="password" class="form-control" id="contrasena" name="repetir_contrasena" placeholder="Repetir Contraseña"
                required>
            </div>
...
<script>
  ...
  registrar_button.addEventListener('click', function (e) {
    ...
    if (json_data.nombre == '' || json_data.telefono == '' || json_data.direccion == '' || json_data.genero == '' || json_data.correo == '' || json_data.contrasena == '') {
      Swal.fire({
        icon: 'error',
        title: 'Oops...',
